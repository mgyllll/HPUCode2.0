...
if __name__ == '__main__':
    ...
    for q in range(5, 55, 5):
        ...
        for l in range(68, 116, 12):
            ...
            PCNNList.append([l, pcnnList['precision'].mean(), pcnnList['recall'].mean(), pcnnList['f1'].mean(), pcnnList['auc'].mean()])
        PCNNList = pd.DataFrame(PCNNList, columns=['l', 'precision', 'recall', 'f1', 'auc'])
        PCNNList.to_csv('../data/moviesData/result/BiNCNN12060840_ml_' + str(q) + '.csv', index=False, encoding="utf_8_sig")
